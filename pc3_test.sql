...
-- PC3
SELECT COUNT(*) AS Students_PC3 FROM Student WHERE AdmissionNumber BETWEEN 11 AND 15;
SELECT COUNT(*) AS Courses_PC3 FROM Course WHERE CourseID BETWEEN 7 AND 10;
SELECT COUNT(*) AS Enrollments_PC3 FROM Enrolled WHERE AdmissionNumber BETWEEN 11 AND 15;
